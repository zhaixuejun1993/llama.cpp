...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    // { LLM_ARCH_PHI2,             "phi2"             }, // accuracy issue need to debug
    // { LLM_ARCH_PHI3,             "phi3"             },
    // { LLM_ARCH_PHIMOE,           "phimoe"           },
    // { LLM_ARCH_PLAMO,            "plamo"            },
    // { LLM_ARCH_PLAMO2,           "plamo2"           }, // failed
    // { LLM_ARCH_PLAMO3,           "plamo3"           }, // accuracy issue need to debug
    // { LLM_ARCH_CODESHELL,        "codeshell"        }, // accuracy issue need to debug
    // { LLM_ARCH_ORION,            "orion"            },
    // { LLM_ARCH_INTERNLM2,        "internlm2"        },
    // { LLM_ARCH_MINICPM,          "minicpm"          },
    // { LLM_ARCH_MINICPM3,         "minicpm3"         }, // failed, need to debug
    // { LLM_ARCH_GEMMA,            "gemma"            },
    // { LLM_ARCH_GEMMA2,           "gemma2"           },
    // { LLM_ARCH_GEMMA3,           "gemma3"           },
    // { LLM_ARCH_GEMMA3N,          "gemma3n"          }, // failed, need to debug
    // { LLM_ARCH_GEMMA_EMBEDDING,  "gemma-embedding"  },
    // { LLM_ARCH_STARCODER2,       "starcoder2"       },
    // { LLM_ARCH_MAMBA,            "mamba"            }, // failed, need to debug
    // { LLM_ARCH_MAMBA2,           "mamba2"           }, // failed, need to debug
    // { LLM_ARCH_JAMBA,            "jamba"            }, // failed, need to debug
    // { LLM_ARCH_FALCON_H1,        "falcon-h1"        }, // failed, need to debug
    ...
    // { LLM_ARCH_DEEPSEEK2,        "deepseek2"        }, // failed, need to debug
    // { LLM_ARCH_CHATGLM,          "chatglm"          }, // accuracy issue need to debug
    // { LLM_ARCH_GLM4,             "glm4"             }, // failed, need to debug
    // { LLM_ARCH_GLM4_MOE,         "glm4moe"          },
    // { LLM_ARCH_GLM_DSA,          "glm-dsa"          }, // failed, need to debug
    ...
    // { LLM_ARCH_NEMOTRON_H,       "nemotron_h"       }, // failed, need to debug
    // { LLM_ARCH_NEMOTRON_H_MOE,   "nemotron_h_moe"   }, // failed, need to debug
    ...
    // { LLM_ARCH_GRANITE_MOE,      "granitemoe"       }, // failed, need to debug
    // { LLM_ARCH_GRANITE_HYBRID,   "granitehybrid"    }, // failed, need to debug
    // { LLM_ARCH_CHAMELEON,        "chameleon"        }, // failed, need to debug
    ...
    // { LLM_ARCH_GROVEMOE,         "grovemoe"         }, // failed, need to debug
    ...
    // { LLM_ARCH_MISTRAL4,         "mistral4"         }, // failed, need to debug
    // { LLM_ARCH_PADDLEOCR,        "paddleocr"        },
    // { LLM_ARCH_MIMO2,            "mimo2"            },
    // { LLM_ARCH_STEP35,           "step35"           },
    // { LLM_ARCH_LLAMA_EMBED,      "llama-embed"      },
    // { LLM_ARCH_MAINCODER,        "maincoder"        },
    // { LLM_ARCH_KIMI_LINEAR,      "kimi-linear"      }, // failed, need to debug
